...
#      offline in seeded test mode (AddressLookupServiceSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "AddressLookupService_sdk.rb")
  SDK_CLASS = "AddressLookupServiceSDK"
  ...
  SDK_BASE = "AddressLookupService_sdk"
