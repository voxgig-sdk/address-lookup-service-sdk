...
type AddressLookupServiceSDK struct {
	Mode     string
...
func (sdk *AddressLookupServiceSDK) OptionsMap() map[string]any {
...
func (sdk *AddressLookupServiceSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *AddressLookupServiceSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *AddressLookupServiceSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AddressLookupServiceSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *AddressLookupServiceSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *AddressLookupServiceSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("AddressLookupServiceSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *AddressLookupServiceSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AddressLookupServiceSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("AddressLookupServiceSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *AddressLookupServiceSDK {
	...
	sdk := NewAddressLookupServiceSDK(sdkopts)
	sdk.Mode = "test"
