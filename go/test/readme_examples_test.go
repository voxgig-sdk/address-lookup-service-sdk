...
const testSeed = `map[string]any{"entity": map[string]any{"search_addresses_get": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "search_addresses_post": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
