...
// SearchAddressesGet is the typed data model for the search_addresses_get entity.
type SearchAddressesGet struct {
...
type SearchAddressesPost struct {
	SuggestedAddress *[]any `json:"SuggestedAddress,omitempty"`
