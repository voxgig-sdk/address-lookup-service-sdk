...
// AddressLookupService SDK utility type

class AddressLookupServiceUtility
{
    ...
    public static function copy(AddressLookupServiceUtility $src): AddressLookupServiceUtility
    {
        $u = new AddressLookupServiceUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
