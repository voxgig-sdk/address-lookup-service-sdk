...
// AddressLookupService SDK cache feature
...
class AddressLookupServiceCacheFeature extends AddressLookupServiceBaseFeature
{
    ...
    private function _through(AddressLookupServiceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
