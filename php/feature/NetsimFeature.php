...
// AddressLookupService SDK netsim feature
...
class AddressLookupServiceNetsimFeature extends AddressLookupServiceBaseFeature
{
    ...
    private function _simulate(AddressLookupServiceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(AddressLookupServiceContext $ctx, array $applied): void
    {
        $client = $this->client;
