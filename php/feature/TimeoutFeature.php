...
// AddressLookupService SDK timeout feature
...
class AddressLookupServiceTimeoutFeature extends AddressLookupServiceBaseFeature
{
    ...
    private function _with_timeout(AddressLookupServiceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(AddressLookupServiceContext $_ctx, float $ms): void
    {
        $client = $this->client;
