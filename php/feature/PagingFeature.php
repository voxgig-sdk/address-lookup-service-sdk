...
// AddressLookupService SDK paging feature
...
class AddressLookupServicePagingFeature extends AddressLookupServiceBaseFeature
{
    ...
    private function _is_list(AddressLookupServiceContext $ctx): bool
    {
