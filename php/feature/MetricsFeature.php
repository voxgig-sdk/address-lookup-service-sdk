...
// AddressLookupService SDK metrics feature
...
class AddressLookupServiceMetricsFeature extends AddressLookupServiceBaseFeature
{
    ...
    private function _record(AddressLookupServiceContext $ctx, bool $ok): void
    {
