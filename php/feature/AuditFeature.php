...
// AddressLookupService SDK audit feature
...
class AddressLookupServiceAuditFeature extends AddressLookupServiceBaseFeature
{
    ...
    private function _emit(AddressLookupServiceContext $ctx, string $outcome): void
    {
