...
// AddressLookupService SDK ratelimit feature
...
class AddressLookupServiceRatelimitFeature extends AddressLookupServiceBaseFeature
{
    ...
    private function _acquire(AddressLookupServiceContext $ctx): void
    {
    ...
    private function _track(AddressLookupServiceContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
