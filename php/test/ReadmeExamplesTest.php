...
// AddressLookupService SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (AddressLookupServiceSDK::test)
...
{
    private const SDK_CLASS = 'AddressLookupServiceSDK';
    ...
    private const SDK_BASE = 'addresslookupservice_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../addresslookupservice_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
