...
class AddressLookupServiceTestRunner
{
    ...
    {
        $live = self::getenv('ADDRESSLOOKUPSERVICE_TEST_LIVE');
        $override = self::getenv('ADDRESSLOOKUPSERVICE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('ADDRESSLOOKUPSERVICE_TEST_EXPLAIN');
