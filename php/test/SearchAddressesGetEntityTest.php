...
class SearchAddressesGetEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set ADDRESSLOOKUPSERVICE_TEST_SEARCH_ADDRESSES_GET_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function search_addresses_get_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("ADDRESSLOOKUPSERVICE_TEST_SEARCH_ADDRESSES_GET_ENTID");
