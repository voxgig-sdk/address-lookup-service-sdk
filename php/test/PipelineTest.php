...
// AddressLookupService SDK pipeline test
//
...
{
    private static function utility(): AddressLookupServiceUtility
    {
        return new AddressLookupServiceUtility();
    }
    ...
    private static function ctx(array $over = []): AddressLookupServiceContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new AddressLookupServiceContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new AddressLookupServiceOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof AddressLookupServiceError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new AddressLookupServiceOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = AddressLookupServiceMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new AddressLookupServiceOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = AddressLookupServiceMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new AddressLookupServiceOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = AddressLookupServiceMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new AddressLookupServiceSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = AddressLookupServiceMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new AddressLookupServiceResponse([]),
            'result' => new AddressLookupServiceResult([]),
        ]);
        [, $err] = AddressLookupServiceMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new AddressLookupServiceSpec([]),
            'response' => null,
            'result' => new AddressLookupServiceResult([]),
        ]);
        [, $err] = AddressLookupServiceMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new AddressLookupServiceSpec(['step' => 's']),
            'response' => new AddressLookupServiceResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new AddressLookupServiceResult([]),
        ]);
        [, $err] = AddressLookupServiceMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new AddressLookupServiceSpec(['step' => 's']),
            'response' => new AddressLookupServiceResponse(self::resp(200, ['v' => 1])),
            'result' => new AddressLookupServiceResult([]),
        ]);
        [, $err] = AddressLookupServiceMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new AddressLookupServiceSpec(['step' => 's']),
            'response' => new AddressLookupServiceResponse(self::resp(200, ['v' => 2])),
            'result' => new AddressLookupServiceResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        AddressLookupServiceMakeResponse::call($ctx);
    ...
    {
        $preset = new AddressLookupServiceResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new AddressLookupServiceSpec([]),
            'response' => new AddressLookupServiceResponse([]),
            'result' => new AddressLookupServiceResult([]),
        ...
        [$got, $err] = AddressLookupServiceMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new AddressLookupServiceResult([])]);
        [, $err] = AddressLookupServiceMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new AddressLookupServiceSpec([]), 'result' => null]);
        [, $err] = AddressLookupServiceMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new AddressLookupServiceSpec(['step' => 's']),
            'result' => new AddressLookupServiceResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new AddressLookupServiceOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = AddressLookupServiceMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new AddressLookupServiceSpec(['step' => 's']),
            'result' => new AddressLookupServiceResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new AddressLookupServiceOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = AddressLookupServiceMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new AddressLookupServiceResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new AddressLookupServiceSpec([]),
            'result' => new AddressLookupServiceResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = AddressLookupServiceMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = AddressLookupServiceMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new AddressLookupServiceError('boom', 'boom');
        $utility->fetcher = function (AddressLookupServiceContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new AddressLookupServiceSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = AddressLookupServiceMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (AddressLookupServiceContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = AddressLookupServiceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(AddressLookupServiceResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        AddressLookupServiceMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (AddressLookupServiceContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new AddressLookupServiceSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = AddressLookupServiceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new AddressLookupServiceResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new AddressLookupServiceSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = AddressLookupServiceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = AddressLookupServiceMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = AddressLookupServiceMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new AddressLookupServiceResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, AddressLookupServiceDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new AddressLookupServiceResult(['ok' => false])]);
        $this->expectException(AddressLookupServiceError::class);
        AddressLookupServiceDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new AddressLookupServiceResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', AddressLookupServiceMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        AddressLookupServiceMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new AddressLookupServiceBaseFeature();
        $b = new AddressLookupServiceBaseFeature();
        AddressLookupServiceFeatureAdd::call($ctx, $a);
        AddressLookupServiceFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): AddressLookupServiceBaseFeature
    {
        $f = new AddressLookupServiceBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        AddressLookupServiceFeatureAdd::call($ctx, self::named_feature('a'));
        AddressLookupServiceFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        AddressLookupServiceFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        AddressLookupServiceFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        AddressLookupServiceFeatureAdd::call($ctx, $replace);
        ...
        AddressLookupServiceFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): AddressLookupServiceContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new AddressLookupServiceSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = AddressLookupServicePrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        AddressLookupServicePrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new AddressLookupServiceResponse(['headers' => null]),
            'result' => new AddressLookupServiceResult([]),
        ]);
        AddressLookupServiceResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        AddressLookupServiceResultBody::call($ctx);
