...
// AddressLookupService SDK utility: graphql
//
...
class AddressLookupServiceGraphql
{
    ...
    // equivalent.
    public static function body(AddressLookupServiceContext $ctx): mixed
    {
    ...
    public static function errors(AddressLookupServiceContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
