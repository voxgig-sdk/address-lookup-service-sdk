...
// AddressLookupService SDK utility: result_basic

class AddressLookupServiceResultBasic
{
    public static function call(AddressLookupServiceContext $ctx): ?AddressLookupServiceResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof AddressLookupServiceError) ? $result->err->msg : (string)$result->err;
