...
// AddressLookupService SDK utility: fetcher

class AddressLookupServiceFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; AddressLookupServiceSDK/1.0)';
    ...
    public static function call(AddressLookupServiceContext $ctx, string $fullurl, array $fetchdef): array
    {
