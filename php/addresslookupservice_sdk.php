...
class AddressLookupServiceSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = AddressLookupServiceHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = AddressLookupServiceHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!AddressLookupServiceFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, AddressLookupServiceFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return AddressLookupServiceUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = AddressLookupServiceHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = AddressLookupServiceHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = AddressLookupServiceHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new AddressLookupServiceError($op . "_allow",
                "AddressLookupServiceSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = AddressLookupServiceHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new AddressLookupServiceError("graphql_error",
                "AddressLookupServiceSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function SearchAddressesGet($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_search_addresses_get === null) {
                $this->_search_addresses_get = new SearchAddressesGetEntity($this, null);
            }
            return $this->_search_addresses_get;
        }
        return new SearchAddressesGetEntity($this, $data);
    }
    ...
    public function SearchAddressesPost($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_search_addresses_post === null) {
                $this->_search_addresses_post = new SearchAddressesPostEntity($this, null);
            }
            return $this->_search_addresses_post;
        }
        return new SearchAddressesPostEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new AddressLookupServiceSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
