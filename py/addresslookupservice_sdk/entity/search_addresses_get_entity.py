...
from addresslookupservice_sdk.addresslookupservice_types import (
    SearchAddressesGet,
...
class SearchAddressesGetEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SearchAddressesGetEntity(self._client, opts)
    ...
    def data_get(self) -> SearchAddressesGet:
    ...
    def match_get(self) -> SearchAddressesGet:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[SearchAddressesGet]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.SearchAddressesGet().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
