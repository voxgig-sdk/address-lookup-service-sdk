...
class SearchAddressesPostEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SearchAddressesPostEntity(self._client, opts)
    ...
    def data_get(self) -> SearchAddressesPost:
    ...
    def match_get(self) -> SearchAddressesPost:
    ...
    def create(self, reqdata: SearchAddressesPostCreateData, ctrl=None) -> SearchAddressesPost:
        utility = self._utility
