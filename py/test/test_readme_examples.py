# AddressLookupService SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions AddressLookupServiceSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both AddressLookupServiceSDK(...) and AddressLookupServiceSDK.test(...) become
#      AddressLookupServiceSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "addresslookupservice_sdk"
_SDK_CLASS = "AddressLookupServiceSDK"
...
_ENTITIES = {
    "SearchAddressesGet": "search_addresses_get",
    "SearchAddressesPost": "search_addresses_post",
}
