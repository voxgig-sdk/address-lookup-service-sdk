...
function runner.env_override(m)
  local live = runner.getenv("ADDRESS_LOOKUP_SERVICE_TEST_LIVE")
  local override = runner.getenv("ADDRESS_LOOKUP_SERVICE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("ADDRESS_LOOKUP_SERVICE_TEST_EXPLAIN")
