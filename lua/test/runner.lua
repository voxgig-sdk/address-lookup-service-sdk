...
function runner.env_override(m)
  local live = runner.getenv("ADDRESSLOOKUPSERVICE_TEST_LIVE")
  local override = runner.getenv("ADDRESSLOOKUPSERVICE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("ADDRESSLOOKUPSERVICE_TEST_EXPLAIN")
