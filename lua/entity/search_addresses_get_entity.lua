...
local SearchAddressesGetEntity = {}
SearchAddressesGetEntity.__index = SearchAddressesGetEntity


function SearchAddressesGetEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SearchAddressesGetEntity)
  self._name = "search_addresses_get"
  self._client = client
...
function SearchAddressesGetEntity:get_name()
  return self._name
end


function SearchAddressesGetEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SearchAddressesGetEntity.new(self._client, opts)
end
...
function SearchAddressesGetEntity:mark_deleted()
  self._deleted = true
end


function SearchAddressesGetEntity:deleted()
  return true == self._deleted
end


function SearchAddressesGetEntity:data_set(args)
  if args ~= nil then
...
function SearchAddressesGetEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SearchAddressesGetEntity:match_set(args)
  if args ~= nil then
...
function SearchAddressesGetEntity:match_get()
...
function SearchAddressesGetEntity:stream(action, args, callopts)
...
function SearchAddressesGetEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return SearchAddressesGetEntity
