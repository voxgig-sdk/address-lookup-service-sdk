...
local SearchAddressesPostEntity = {}
SearchAddressesPostEntity.__index = SearchAddressesPostEntity


function SearchAddressesPostEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SearchAddressesPostEntity)
  self._name = "search_addresses_post"
  self._client = client
...
function SearchAddressesPostEntity:get_name()
  return self._name
end


function SearchAddressesPostEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SearchAddressesPostEntity.new(self._client, opts)
end
...
function SearchAddressesPostEntity:mark_deleted()
  self._deleted = true
end


function SearchAddressesPostEntity:deleted()
  return true == self._deleted
end


function SearchAddressesPostEntity:data_set(args)
  if args ~= nil then
...
function SearchAddressesPostEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SearchAddressesPostEntity:match_set(args)
  if args ~= nil then
...
function SearchAddressesPostEntity:match_get()
...
function SearchAddressesPostEntity:stream(action, args, callopts)
...
function SearchAddressesPostEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return SearchAddressesPostEntity
