...
// AddressLookupService SDK idempotency feature
...
class AddressLookupServiceIdempotencyFeature extends AddressLookupServiceBaseFeature
{
    ...
    private function _mutating(AddressLookupServiceContext $ctx): bool
    {
