...
// AddressLookupService SDK proxy feature
...
class AddressLookupServiceProxyFeature extends AddressLookupServiceBaseFeature
{
    ...
    public function init(AddressLookupServiceContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (AddressLookupServiceContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
