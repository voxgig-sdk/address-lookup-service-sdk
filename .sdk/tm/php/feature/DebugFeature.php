...
// AddressLookupService SDK debug feature
...
class AddressLookupServiceDebugFeature extends AddressLookupServiceBaseFeature
{
    ...
    private function _finish(AddressLookupServiceContext $ctx, bool $ok): void
    {
