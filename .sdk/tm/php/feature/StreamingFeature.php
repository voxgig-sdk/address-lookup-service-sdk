...
// AddressLookupService SDK streaming feature
...
class AddressLookupServiceStreamingFeature extends AddressLookupServiceBaseFeature
{
    ...
    private function _iterate(AddressLookupServiceResult $result): \Generator
    {
    ...
    private function _streamable(AddressLookupServiceContext $ctx): bool
    {
