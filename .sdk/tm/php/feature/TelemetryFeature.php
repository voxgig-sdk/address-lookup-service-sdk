...
// AddressLookupService SDK telemetry feature
...
class AddressLookupServiceTelemetryFeature extends AddressLookupServiceBaseFeature
{
    ...
    private function _close(AddressLookupServiceContext $ctx, bool $ok): void
    {
