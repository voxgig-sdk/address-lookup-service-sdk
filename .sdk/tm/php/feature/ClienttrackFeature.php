...
// AddressLookupService SDK clienttrack feature
...
class AddressLookupServiceClienttrackFeature extends AddressLookupServiceBaseFeature
{
    ...
    public function PostConstruct(AddressLookupServiceContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'AddressLookupService-SDK';
