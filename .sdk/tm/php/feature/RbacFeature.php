...
// AddressLookupService SDK rbac feature
...
class AddressLookupServiceRbacFeature extends AddressLookupServiceBaseFeature
{
    ...
    private function _required(AddressLookupServiceContext $ctx): ?string
    {
    ...
    private function _reject(AddressLookupServiceContext $ctx, string $required): void
    {
    ...
    private function _track(AddressLookupServiceContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
