...
from projectname_sdk.core.control import AddressLookupServiceControl
...
class AddressLookupServiceContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = AddressLookupServiceControl()
        ...
        if isinstance(sp, AddressLookupServiceSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, AddressLookupServiceResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, AddressLookupServiceResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return AddressLookupServiceOperation({})
    ...
    def make_error(self, code, msg):
        return AddressLookupServiceError(code, msg, self)
