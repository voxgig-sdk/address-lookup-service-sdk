# AddressLookupService SDK feature corpus test
#
...
def _client(kase):
    ...
    AddressLookupServiceSDK(...), not AddressLookupServiceSDK.test(...): the `test` feature is
    ...
    return AddressLookupServiceSDK(opts)
