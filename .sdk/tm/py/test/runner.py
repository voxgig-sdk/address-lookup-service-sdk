...
class AddressLookupServiceTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = AddressLookupServiceTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = AddressLookupServiceTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = AddressLookupServiceTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
