...
|---|---|---|
| `ts/` | @voxgig-sdk/address-lookup-service-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/address-lookup-service-sdk \
      --repository voxgig-sdk/address-lookup-service-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/address-lookup-service-sdk` shows it, and
`npm trust revoke @voxgig-sdk/address-lookup-service-sdk --id=<id>` removes it.
