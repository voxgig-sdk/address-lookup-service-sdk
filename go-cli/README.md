...
AQL-driven command-line client **and** interactive REPL for the AddressLookupService
...
- `<entity>` is a bareword, auto-quoted as an AQL atom (e.g. `search_addresses_get`).
