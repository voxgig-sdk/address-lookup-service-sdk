...
AQL-driven CLI and REPL for the AddressLookupService SDK. Positional arguments are
...
```sh
go build -o address-lookup-service-cli ./...
```
...
./address-lookup-service-cli load 1 search_addresses_get
./address-lookup-service-cli load '{id:1}' search_addresses_get
