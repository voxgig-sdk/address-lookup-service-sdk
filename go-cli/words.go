...
func registerSDKWords(r *eng.Registry, client *sdk.AddressLookupServiceSDK) {
...
func runOp(client *sdk.AddressLookupServiceSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
