// Command AddressLookupService-cli is a CLI + REPL for the AddressLookupService SDK,
...
const prompt = "address-lookup-service"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "search_addresses_get search_addresses_post"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      ADDRESS_LOOKUP_SERVICE_APIKEY (api key), ADDRESS_LOOKUP_SERVICE_BASE (base url override)")
