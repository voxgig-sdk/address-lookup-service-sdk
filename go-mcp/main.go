// Command AddressLookupService-mcp is an MCP server exposing the AddressLookupService
// SDK as MCP tools.
//
// Two tools are registered:
//
//	AddressLookupService_list  — list records of an entity
//	AddressLookupService_load  — load a single record of an entity
//
