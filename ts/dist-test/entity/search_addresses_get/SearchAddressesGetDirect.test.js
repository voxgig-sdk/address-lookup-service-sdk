...
(0, node_test_1.describe)('SearchAddressesGetDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.AddressLookupServiceSDK({
    ...
    (0, node_test_1.test)('direct-list-search_addresses_get', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-search_addresses_get', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.AddressLookupServiceSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['ADDRESS_LOOKUP_SERVICE_TEST_SEARCH_ADDRESSES_GET_ENTID'];
    ...
    const client = new __1.AddressLookupServiceSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=SearchAddressesGetDirect.test.js.map