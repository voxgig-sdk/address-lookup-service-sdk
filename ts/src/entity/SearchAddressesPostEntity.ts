...
class SearchAddressesPostEntity extends AddressLookupServiceEntityBase<SearchAddressesPost> {
  ...
  make(this: SearchAddressesPostEntity) {
  ...
  async create(this: any, reqdata?: SearchAddressesPostCreateData, ctrl?: Control): Promise<SearchAddressesPostEntity> {
